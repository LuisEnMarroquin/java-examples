...
public class Pi162$ArrayList_Empleado {
  ...
  public static void main(String[] args) {
    ...
    //listaEmpleados.add(new Empleado2("Olga", 16, 14678)); // Para poner este empleado a cierta posici�n del ArrayList
