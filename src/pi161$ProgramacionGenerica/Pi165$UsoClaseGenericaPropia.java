...
public class Pi165$UsoClaseGenericaPropia {
	...
	public static void main(String[] args) {
		...
		System.out.println(otra.getPrimero()); // Devuelve la referencia a Objeto cuando no se sobreescribe el método '.toString' de la clase 'Object'
...
class Persona {
	...
	public String toString() { // Comentar esta sobreescritura del método '.toString()' para ver como se devuelve un objeto
		return nombre;
	}
