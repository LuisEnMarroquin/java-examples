...
public class Pi163$ArrayList_Empleado {
	...
	public static void main(String[] args) {
		...
		//listaEmpleados.add(new Empleado3("Olga", 16, 14678)); // Para poner este empleado a cierta posición del ArrayList
