...
public class Pi046$UsoPersona {
  ...
  public static void main(String[] args) {
    ...
    Persona[] lasPersonas = new Persona[2]; // 2 porque tendr� solo 2 personas.
    lasPersonas [0] = new Empleado("Andres", 50000, 2009, 02, 25);
    lasPersonas [1] = new Alumno("Andrea", "Biolog�a");
...
class Empleado extends Persona{
  ...
  public Empleado(String nom, double sue, int agno,  int mes, int dia) {
    ...
    GregorianCalendar calendario = new GregorianCalendar(agno, mes-1, dia); //Usando el m�todo contructor de la clase GregorianCalendar(int year, int month(Enero=0, Febrero=1...), int dayOfTheMonth).
...
class Alumno extends Persona{
  ...
  public Alumno(String nom, String car) { //Como se est� heredando de la clase Persona lo primero que hay que hacer es mandar a llamar al constructor de la clase padre;
    super(nom);
    carrera = car;
  }
