...
class LaminaConImagen3 extends JPanel{
  ...
  public LaminaConImagen3() { // IOExeption = Excepci�n comprobada (lo programaste bien)
  ...
  public void paintComponent(Graphics g) throws NullPointerException {
    ...
    try { // EXCEPCION NO COMPROBADA == RUNTIME
      ...
      int anchoImagen = imagen.getWidth(this); //This hace referencia a el objeto en que se encuentra, es decir la l�mina 'LaminaConImagen3'
