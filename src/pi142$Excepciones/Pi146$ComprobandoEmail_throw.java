...
public class Pi146$ComprobandoEmail_throw {

	public static void main(String[] args) {
		
		
		System.out.println("Evaluando si una dirección de email es correcta o no analisando si lleva o no '@' o un '.'");
	...
	static void examinaMail(String mail) throws ArrayIndexOutOfBoundsException{ // This throws is only to indicate to other programmers that this method can generate an exception
		...
		if(mail.length() <= 3) { // If the length of the email is 3 or less than 3
			...
			throw new ArrayIndexOutOfBoundsException(); // The same thing that the 2 lines up, but simplified
