...
public class Pi196$Servidor {
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		MarcoServidor6 mimarco=new MarcoServidor6();
...
class MarcoServidor6 extends JFrame implements Runnable{ // Implementa Runnable para hacer 'Threads' para que esté permanentemente a la escucha de mensajes
	
	public MarcoServidor6(){
	...
	public void run() {
		...
		try {
			...
			PaqueteEnvio6 paqueteRecibido; // Intancia de 'PaqueteEnvio6' llamada 'paqueteRecibido' // Hay que inicializar la variable para poder usarla
			...
			while(true) { // Dentro de un bucle infinito para que acepte más mensajes
				...
				paqueteRecibido = (PaqueteEnvio6) paqueteDatos.readObject(); // Lanza excepción de tipo 'ClassNotFoundException'
