...
class EstoyOnline3 extends WindowAdapter{ // 'WindowAdapter' es una clase adaptadora de la interfaz 'WindowListener' para no tener que implementar todos los m�todos de esta interfaz
  ...
  private class EnviaTexto implements ActionListener{ // Creando clase interna para el bot�n de Enviar
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      try {
        ...
        datos.setNick(nick.getText()); // Guardando lo que est� dentro de las areas de texto en los Setters de la clase 'PaqueteEnvio9'
