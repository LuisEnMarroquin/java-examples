...
class EstoyOnline4 extends WindowAdapter{ // 'WindowAdapter' es una clase adaptadora de la interfaz 'WindowListener' para no tener que implementar todos los métodos de esta interfaz
	...
	private class EnviaTexto implements ActionListener{ // Creando clase interna para el botón de Enviar
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				datos.setNick(nick.getText()); // Guardando lo que está dentro de las areas de texto en los Setters de la clase 'PaqueteEnvio10'
