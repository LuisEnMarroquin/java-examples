...
class MarcoServidor9 extends JFrame implements Runnable{ // Implementa Runnable para hacer 'Threads' para que esté permanentemente a la escucha de mensajes
	...
	public void run() {
		...
		try {
			...
			while(true) { // Dentro de un bucle infinito para que acepte más mensajes
				...
				paqueteRecibido = (PaqueteEnvio9) paqueteDatos.readObject(); // Lanza excepción de tipo 'ClassNotFoundException'
