...
public class Pi197$Servidor {
	
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		MarcoServidor7 mimarco=new MarcoServidor7();
...
class MarcoServidor7 extends JFrame implements Runnable{ // Implementa Runnable para hacer 'Threads' para que esté permanentemente a la escucha de mensajes
	
	public MarcoServidor7(){
	...
	public void run() {
		...
		try {
			...
			PaqueteEnvio7 paqueteRecibido; // Intancia de 'PaqueteEnvio7' llamada 'paqueteRecibido' // Hay que inicializar la variable para poder usarla
			...
			while(true) { // Dentro de un bucle infinito para que acepte más mensajes
				...
				paqueteRecibido = (PaqueteEnvio7) paqueteDatos.readObject(); // Lanza excepción de tipo 'ClassNotFoundException'
