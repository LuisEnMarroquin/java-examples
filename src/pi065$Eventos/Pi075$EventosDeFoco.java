...
class LaminaFoco2 extends JPanel{
	...
	private class LlevaArroba implements FocusListener{ //Se implementan los 2 métodos pertenecientes a la interfaz.
		...
		public void focusLost(FocusEvent e) {
			...
			String email = cuadro1.getText(); //Método de la clase 'JTextComponent' que es de la que hereda 'JTextField'
