...
class LaminaConBotones extends JPanel implements ActionListener{ //La interfaz 'ActionListener' pertenece a 'java.awt.event.*;'
  ...
  @Override //El m�todo 'actionPerformed' pertenece a la interfaz 'ActionListener'
  public void actionPerformed(ActionEvent e) { //Al hacer click en el bot�n Java contruye un evento que viene a almacenarse dentro.

    Object botonPulsado = e.getSource(); //OBTENIENDO QUIEN FUE EL DESENCADENANDTE DE LA ACCI�N
