...
class PanelAccion extends JPanel{
	...
	//Como los botónes se van a usar dentro del panel se declaran aquí
	public PanelAccion() {
		...
		add(new JButton(accionRojo)); //Después de esto el programa continuará en acctionColor -> actionPerformed.
		
		/*JButton botonAmarillo = new JButton("Amarillo"); //Construyendo los botones de forma antigua
		JButton botonAzul = new JButton("Azul");
		JButton botonRojo = new JButton("Rojo");
		//Agregando los botónes a la lámina
		add(botonAmarillo);
		add(botonAzul);
		add(botonRojo);*/
