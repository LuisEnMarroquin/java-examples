...
class MarcoEstado extends JFrame{
  ...
  public MarcoEstado() {
    ...
    CambiaEstado nuevoEstado = new CambiaEstado(); //Poniendo la ventana a la escucha del m�todo
...
class CambiaEstado implements WindowStateListener{
  ...
  public void windowStateChanged(WindowEvent e) {
    ...
    if(e.getNewState() == Frame.MAXIMIZED_BOTH) { // '6' = VentanaCompleta
      System.out.println("La ventana est� a pantalla completa");
    }else if(e.getNewState() == Frame.NORMAL) { // '0' NoVentanaCompleta
      System.out.println("La ventana no est� a pantalla completa");
