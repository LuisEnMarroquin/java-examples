...
import java.util.*; //Se pueden tener muchos constructores pero no pueden recibir el mismo n�mero de argumentos.

public class Pi039$POO_TrabajarConUnFichero_UsoEmpleado { //Hay m�s de 1 clase en este programa, por ello solo 1 debe ser p�blica y solo esa debe tener el m�todo main.
