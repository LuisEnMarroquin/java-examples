package pi168$Threads; // Lo mismo del video 176 pero con los métodos 'notifyAll();' y 'wait();' de la clase Object y la palabra reservada 'synchronized' en el método transferencia

//--- import java.util.concurrent.locks.Condition;
//--- import java.util.concurrent.locks.Lock;
//--- import java.util.concurrent.locks.ReentrantLock;

public class Pi178$BancoSincronizado_CondicionesDeBloqueosConClaseObject { // Todos los hilos que entran dentro del método 'transferencia' (es decir todos) tarde o temprano terminan haciendo la transferencia

	public static void main(String[] args) { // Explicación de cuando se pueden usar los métodos de 'Object' o los de la interfaz 'Condition' al final del video 178
...
class Banco6 { 
	...
	// Con la palabra reservada 'synchronized' se le dice al método que el método debe estar sincrinizado = El uso de 'synchronized' hace que se comenten todas las lineas que comienzen con '//---'
	public synchronized void transferencia(int cuentaOrigen, int cuentaDestino, double cantidad) throws InterruptedException { // Método que realiza las transferencias // throws InterruptedException = Debido a 'saldoSuficiente.await();'
		...
		//--- try {
			...
			notifyAll(); // Sustituye a 'saldoSuficiente.signalAll();' // Notifica a todos los hilos que pueden haber estado a la espera que ya se ha terminado de ejecutar el método
...
class EjecucionTransferencias5 implements Runnable{ // Método que hará transferencias infinitas
