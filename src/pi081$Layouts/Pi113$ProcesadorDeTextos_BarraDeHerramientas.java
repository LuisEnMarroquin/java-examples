package pi081$Layouts; // Justified works fine, just needs some spacing
...
public class Pi113$ProcesadorDeTextos_BarraDeHerramientas {

	public static void main(String[] args) {
		
		MenuProcesador11 marco = new MenuProcesador11();
...
class MenuProcesador11 extends JFrame {
	public MenuProcesador11() {
		setBounds(500, 300, 550, 400);
		LaminaProcesador11 lamina = new LaminaProcesador11();
		add(lamina);
		setVisible(true);
	}
}

class LaminaProcesador11 extends JPanel {
	
	public LaminaProcesador11() {
		
		setLayout(new BorderLayout()); // Setting 'LaminaProcesador11' layout
		...
		add(laminaMenu, BorderLayout.NORTH); // Adding Panel 'laminaMenu' to the Panel 'LaminaProcesador11'
		
		/*JTextPane*/ area = new JTextPane(); // Creating a new 'JTextPane' // 'JTextPane' is similar to 'JTextArea' but with a few more options
		
		
		
		add(area, BorderLayout.CENTER); // Adding 'area' to the center of 'LaminaProcesador11'
		...
		add(barraDeHerramientas, BorderLayout.WEST); // Adding the toolbar 'barraDeHerramientas' to the left side of the panel 'LaminaProcesador11'
