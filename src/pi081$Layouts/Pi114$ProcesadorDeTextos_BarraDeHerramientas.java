package pi081$Layouts; // Errores conocidos: Los colores no funcionarán cuando se saque la barra del marco porque están construidos con 'foregroundAction' // Video 114 minuto 16:50
...
class LaminaProcesador12 extends JPanel {
	...
	public LaminaProcesador12() {
		...
		configuraBarra("src/pi081$Layouts/yellowCircle.png").addActionListener(new StyledEditorKit.ForegroundAction("Lo que sea", Color.YELLOW)); // Es válido poner el método '.addActionListener()' porque es un objeto de tipo JButton y los JButton tienen este método
