...
public class Pi103$ProcesadorDeTextos {

	public static void main(String[] args) {
		
		MenuProcesador3 marco = new MenuProcesador3();
...
class LaminaProcesador3 extends JPanel {
	...
	public LaminaProcesador3() {
		...
		setLayout(new BorderLayout()); // Setting 'LaminaProcesador3' layout
		...
		add(laminaMenu, BorderLayout.NORTH); // Adding Panel 'laminaMenu' to the Panel 'LaminaProcesador3'
		
		/*JTextPane*/ area = new JTextPane(); // Creating a new 'JTextPane' // 'JTextPane' is similar to 'JTextArea' but with a few more options
		
		add(area, BorderLayout.CENTER); // Adding 'area' to the center of 'LaminaProcesador3'
