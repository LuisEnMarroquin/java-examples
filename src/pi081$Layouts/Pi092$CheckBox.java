...
class LaminaCheck extends JPanel {
	...
	public LaminaCheck() {
		...
		texto = new JLabel("Esta es una frase a la que se le van a cambiar las características");
		
		texto.setFont(letra); // Pasando un objeto de tipo 'Font' al texto para formatearlo así
