...
public class Pi157$Serializando {
	...
	public static void main(String[] args) {
		...
		try {
			...
			ObjectOutputStream escribiendoFichero = new ObjectOutputStream(new FileOutputStream("D:/empleado.dat")); // Creando stream de salida de datos // Guardará un array
			...
			ObjectInputStream recuperandoFichero = new ObjectInputStream(new FileInputStream("D:/empleado.dat")); // Creando stream de entrada de datos // Recibirá un array
