...
public class Pi155$LecturaEscritura_StreamsByte { // Este prigrama imprime los bytes de los que está formada la imagen
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(!finalArchivo) {
				...
				if(byteEntrada == -1) // '-1' es lo que devuelve el método read cuando ha acabado de leer el archivo
