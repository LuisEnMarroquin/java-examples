...
public class Pi155$LecturaEscritura_StreamsByte2 { // Este prigrama imprime los bytes de los que está formada la imagen

	public static void main(String[] args) {
		
		int contador = 0;
		
		int datosEntrada[] = new int [807]; // Array para guardar todos los bytes de la imagen
