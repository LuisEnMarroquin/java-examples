...
public class Pi158$Serializacion_SerialVersionUID { // EXPLICACIÓN IMPORTANTE DEL 'SerialVersionUID' en todo el video 158
	...
	public static void main(String[] args) {
		...
		try {
			...
			ObjectOutputStream escribiendoFichero = new ObjectOutputStream(new FileOutputStream("D:/Empleado2.dat")); // Creando stream de salida de datos // Guardará un array
			...
			ObjectInputStream recuperandoFichero = new ObjectInputStream(new FileInputStream("D:/Empleado2.dat")); // Creando stream de entrada de datos // Recibirá un array
...
class Empleado2 implements Serializable { // Con esta interfaz se le dice a la clase que puede convertirse en bytes
	...
	public String toString(){ // El método 'toString' es de la clase 'Object' y se usa para describir que es lo que hace la clase
