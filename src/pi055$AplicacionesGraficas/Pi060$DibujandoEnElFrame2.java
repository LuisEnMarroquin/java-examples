...
class LaminaConFiguras2 extends JPanel{
	...
	public void paintComponent(Graphics g) {
		...
		Rectangle2D rectangulo = new Rectangle2D.Double(100,100,200,150); //Pertertenece a java.awt.geom.*; //Este es un método constructor de la clase Rectangle2D.Double
		...
		elipse.setFrame(rectangulo);  //Asignando el tamaño del rectangulo a la elipse.
