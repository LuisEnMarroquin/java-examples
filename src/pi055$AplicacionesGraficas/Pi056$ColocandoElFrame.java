...
class miMarco2 extends JFrame{ //Heredando de JFrame que viene en javax.swing.*;
	...
	//Constructor
	public miMarco2() { //Método de la clase JFrame.

		setVisible(true); //Haciendo la ventana visible Inicialmente las ventanas de Java son invisibles.

		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Haciendo que termine la ejecución al cerrar la ventana.
		
		//setSize(500,300); //Inicialmente las ventanas tienen un tamaño inutil de 0*0 pixeles.
		//setLocation(500,300); //Poniendo la ubicación de la ventana en 'x=500' y 'y=300' considerando la esquina superior izquierda como '0,0' //VIDEO 56 min 6. 
