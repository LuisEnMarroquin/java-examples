...
public class Pi044$UsoEmpleado { //Hay más de 1 clase en este programa, por ello solo 1 debe ser pública y solo esa debe tener el método main.
	...
	public static void main(String[] args) { 
		...
		/*44*/Jefatura jefa_finanzas = (Jefatura)misEmpleados[5]; //Refundición o Casting
