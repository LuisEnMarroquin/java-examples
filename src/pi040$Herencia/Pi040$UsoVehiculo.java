...
public class Pi040$UsoVehiculo {
	...
	public static void main(String[] args) { 
		...
		Pi040$Coche micoche1 = new Pi040$Coche(); // NombreDeLaClase NombreDelObjeto = new NombreDelMétodoConstructor().
		
		micoche1.establece_color("Rojo");
		
		//Instancia a la clase Pi040$Furgoneta
		Pi040$Furgoneta mifurgoneta1 = new Pi040$Furgoneta(7, 580); //Hay que pasarle 2 parámetos afuerza porque en la clase Pi040$Furgoneta se pudo así
