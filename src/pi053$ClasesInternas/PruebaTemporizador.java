...
import java.util.Date; //Para 'Date' (se pone en especifico porque tambi�n hay un Timer en java.util)
...
public class PruebaTemporizador {
  ...
  public static void main(String[] args) {
    ...
    //ActionListener oyente = new DameLaHora(); //Esto tambi�n funcionar�a.
    ...
    //Se pone esta ventana porque mantiene la ejecuci�n del programa mientras la muestra.
...
class DameLaHora implements ActionListener{
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    //Toolkit es una clase que permite acceder a recursos del Sistema Operativo como a la resoluci�n del monitor, recursos de sonido, etc.
