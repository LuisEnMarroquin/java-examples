...
//Una 'Clase Interna Local' es una clase que está dentro de otra clase y a la vez dentro de un método.
...
public static void main(String[] args) {
		...
		//Instanciando reloj
		Reloj2 mireloj = new Reloj2(); //#54 - Reloj2 ahora es el constructor por defecto ya que se quitó el constructor modificado
...
class Reloj2{
	...
	//Método para poner en marcha el programa. /*intervalo = No es final porque la 'Clase Interna Local' no está accediendo a sonido*/
	public void/*Setter*/ enMarcha(int intervalo, final /*Debe ser final cuando sea usada por una 'variable interna local'*/ boolean sonido) { //#54
		...
		//Clase Interna Local //Las 'Clases Internas Locales' no pueden tener modificadores de acceso y van dentro de un método
		class DameLaHora3 implements ActionListener{ //ESTA CLASE SE PUEDE ACCEDER A LAS PROPIEDADES Y MÉTODOS DE LA CLASE QUE LA CONTIENE PERO LA CLASE QUE LA CONTIENE NO PUEDE ACCEDER A ESTA CLASE A NO SER QUE SEA POR MEDIO DE GETTERS Y SETTERS
...
//Una clase interna local es una clase sin modificador de acceso dentro de un método 