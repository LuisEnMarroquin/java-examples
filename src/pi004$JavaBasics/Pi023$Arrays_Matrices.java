...
public class Pi023$Arrays_Matrices { //Los arrays solo pueden almacenar datos del mismo tipo
	...
	public static void main(String[] args) { // QueDatosAlmacenará[] nombre = new TipoDeDatos[CantidadDeDatos];
		
		//Declarando una matriz para 5 datos de tipo entero.
		int[] nombre = new int[5];
		//Iniciando los valores de la matríz en diferente linea que la declaración.
		nombre[0]=15;
		nombre[1]=15;
		nombre[2]=15;
		nombre[3]=15;
