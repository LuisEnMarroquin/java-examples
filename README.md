...
El modificador private en Java es el m�s restrictivo de todos, b�sicamente cualquier elemento de una clase que sea privado
puede ser accedido �nicamente por la misma clase y por nada m�s. Es decir, si por ejemplo, un atributo es privado solo puede
ser accedido por lo m�todos o constructores de la misma clase. Ninguna otra clase sin importar la relaci�n que tengan podr�
tener acceso a ellos.

El modificador por defecto (default)
Java nos da la opci�n de no usar un modificador de acceso y al no hacerlo, el elemento tendr� un acceso conocido como default
...
aqu� la importancia de declararle siempre un paquete a nuestras clases).
...
Modificador public
El modificador de acceso public es el m�s permisivo de todos, b�sicamente public es lo contrario a private en todos los aspectos
(l�gicamente), esto quiere decir que si un componente de una clase es public, tendremos acceso a �l desde cualquier clase o
instancia sin importar el paquete o procedencia de �sta.
...
- Ex�men: Cuando se quiere acceder a una posici�n que no existe de un arreglo lanzar� este error = java.lang.ArrayIndexOutOfBoundsException
- [] = indican que es un array.
- Todas las clases de Java heredan de otra, por defecto todas heredan de Object = extends Object.

- Decalraci�n de arreglos bidimensionales.
...
- p = 2_333_456 = 2333456 //Esos guiones bajos son para hacer el n�mero m�s legible para el programador pero es lo mismo p�nerlos o no.
...
- Polimorfismo: Sobrecarga de m�todos. Un m�todo declarado condiferente lista de m�todos.
