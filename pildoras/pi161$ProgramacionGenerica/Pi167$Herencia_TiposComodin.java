...
public class Pi167$Herencia_TiposComodin {
  ...
  public static void main(String[] args) {
    ...
    Pareja.imprimirTrabajador(DirectoraComercial); // Para permitir la herencia de esta manera se modific� la clase 'Pareja'
...
class Pareja<T> {
  ...
  public static void imprimirTrabajador(Pareja<? extends Employee> p) { // Comod�n para permitir la herencia = <Employee> se cambi� por <? extends Employee>
