...
public class Pi057$CentrandoElFrame {
  ...
  public static void main(String[] args) {
    ...
    instancia.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Que detenga la aplicaci�n al cerrar la ventana.
...
class MarcoCentrado extends JFrame{
  ...
  public MarcoCentrado() {
    ...
    setSize(anchoPantalla/2, alturaPantalla/2); //Haciendo el cuadro del tama�o de la mitad de la pantalla.

    setLocation(anchoPantalla/4, alturaPantalla/4); //Poniendo el cuadro en el centro de la pantalla.

    setTitle("Minecraft"); //Poniendole t�tulo a la ventana.

    Image miIcono = mipantalla.getImage("src/pi055$AplicacionesGraficas/minecraft.png"); //M�todo 'getImage' de la clase 'Toolkit' //Puede ser 'gif', 'png' o 'jpg'.
