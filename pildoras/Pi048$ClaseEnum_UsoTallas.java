...
public class Pi048$ClaseEnum_UsoTallas {
  ...
  //Cuando se declara un tipo en�merado se debe hacer siempre fuera del main.
  //enum Talla {SMALL, MEDIUM, LARGE}
  //talla = "azul"; //Los tipos en�merados son para que no se pueda poner en una variable un valor que no tenga nada que ver.
  ...
  public static void main(String[] args) {
    ...
    //Esto es una declaraci�n de una variable de tipo talla.
    ...
    Talla l = Talla.LARGE;*/
    //Talla x = Talla.EXTRA; //Esto no se permite porque no est� en el tipo en�merado.
