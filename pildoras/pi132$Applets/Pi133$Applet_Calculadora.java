...
public class Pi133$Applet_Calculadora extends JApplet{ // Original file al Pi085$GridLayout_Calculadora

  public void init() {

    LaminaCalculadora3 lamina = new LaminaCalculadora3(); // Instancing class 'LaminaCalculadora3'
    add(lamina); // To the Applet
