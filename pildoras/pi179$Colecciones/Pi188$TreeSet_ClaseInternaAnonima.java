...
public class Pi188$TreeSet_ClaseInternaAnonima { // TreeSet permite ordenaciones
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Ordenando objetos de tipo Articulo4 (orden en base a la interfaz 'Comparable' de acuerdo al n�mero)");

    Articulo4 primero = new Articulo4(1, "Primer Art�culo");
    Articulo4 segundo = new Articulo4(2, "Segundo Art�culo");
    Articulo4 tercero = new Articulo4(3, "Este es el tercer Art�culo");
    ...
    System.out.println("Ordenando objetos de tipo Articulo4 (en base a la descripcion en orden alfab�tico)");
...
class Articulo4 implements Comparable<Articulo4>{
  ...
  public int compareTo(Articulo4 o) { // Construyendo mi propio m�todo 'compareTo' para ordenar los objetos de tipo Articulo4
