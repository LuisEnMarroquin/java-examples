...
public class Pi182$UsoLibro_MetodosEqualsHashcode { // Lo que determina que los objetos son iguales es el IBSN, no es el ttulo ni el autor
  ...
  public static void main(String[] args) {
    ...
    Libros Libros1 = new Libros("Programando en Java", "Luis Marroqu�n", 25);

    Libros Libros2 = new Libros("Programando en Java 2", "Luis Marroqu�n", 25);

    if(Libros1.equals(Libros2)) { // El m�todo equals de la clase Object no es capaz de dsitinguir si 2 objetos son iguales en clases propias, por eso hay que sobreescribirlo
...
class Libros {
  ...
  /*@Override // Sobreescribiendo el m�todo 'equals'
  public boolean equals(Object obj) { // Este m�todo equals dir� 'true' cuando el ISBN de 2 libros sea igual
