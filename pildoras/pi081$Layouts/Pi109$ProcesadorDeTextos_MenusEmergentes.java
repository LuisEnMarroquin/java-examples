...
public class Pi109$ProcesadorDeTextos_MenusEmergentes {

  public static void main(String[] args) {

    MenuProcesador8 marco = new MenuProcesador8();
...
class MenuProcesador8 extends JFrame {

  public MenuProcesador8() {

    setBounds(500, 300, 550, 400);

    LaminaProcesador8 lamina = new LaminaProcesador8();
...
class LaminaProcesador8 extends JPanel {

  public LaminaProcesador8() {

    setLayout(new BorderLayout()); // Setting 'LaminaProcesador8' layout
    ...
    add(laminaMenu, BorderLayout.NORTH); // Adding Panel 'laminaMenu' to the Panel 'LaminaProcesador8'

    /*JTextPane*/ area = new JTextPane(); // Creating a new 'JTextPane' // 'JTextPane' is similar to 'JTextArea' but with a few more options

    add(area, BorderLayout.CENTER); // Adding 'area' to the center of 'LaminaProcesador8'
