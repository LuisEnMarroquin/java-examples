...
class PanelLayout3 extends JPanel {
  ...
  public PanelLayout3() {
    ...
    add(new JButton("Amarillo"), BorderLayout.NORTH); // El m�todo .add de la clase 'JPanel' puede admitir mas de un arguento
    add(new JButton("Rojo"), BorderLayout.SOUTH);
    add(new JButton("Azul"), BorderLayout.WEST);
    add(new JButton("Verde"), BorderLayout.EAST);
    add(new JButton("Negro")/*, BorderLayout.CENTER*/); // Como es la unica zona que queda todav�a por rellenar, no es necesario especificar donde estar�
  }
