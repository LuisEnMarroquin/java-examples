...
public class Pi112$ProcesadorDeTextos_BarraDeHerramientas {

  public static void main(String[] args) {

    MenuProcesador10 marco = new MenuProcesador10();
...
class MenuProcesador10 extends JFrame {

  public MenuProcesador10() {

    setBounds(500, 300, 550, 400);

    LaminaProcesador10 lamina = new LaminaProcesador10();
...
class LaminaProcesador10 extends JPanel {

  public LaminaProcesador10() {

    setLayout(new BorderLayout()); // Setting 'LaminaProcesador10' layout
    ...
    add(laminaMenu, BorderLayout.NORTH); // Adding Panel 'laminaMenu' to the Panel 'LaminaProcesador10'

    /*JTextPane*/ area = new JTextPane(); // Creating a new 'JTextPane' // 'JTextPane' is similar to 'JTextArea' but with a few more options

    add(area, BorderLayout.CENTER); // Adding 'area' to the center of 'LaminaProcesador10'
    ...
    JButton negritaBarra = new JButton(new ImageIcon("src/pi081$Layouts/bold.png")); // Creating a button
    ...
    negritaBarra.addActionListener(new StyledEditorKit.BoldAction()); // Adding action
    ...
    add(barraDeHerramientas, BorderLayout.WEST); // Adding the toolbar 'barraDeHerramientas' to the left side of the panel 'LaminaProcesador10'
