...
class MarcoVentana2 extends JFrame {
  ...
  public MarcoVentana2() {
    ...
    //Lo de arriba de una forma m�s simple
    addWindowListener(new M_Ventana2()); //En vez de crear un objeto perteneciente a esa instancia se instancia directamente aqu�

  }

} //'WindowAdapter' es llamada clase adaptadora igual que 'KeyAdapter' y 'MouseAdapter'

class M_Ventana2 extends WindowAdapter{ //Extendiendo de 'WindowAdapter' que ya implementa los m�todos de 'WindowListener' para no tener que implementar manualmente cada uno y solo poner los que se ocupan
