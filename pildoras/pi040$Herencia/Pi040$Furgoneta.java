...
public class Pi040$Furgoneta extends Pi040$Coche{ //extends trae todas las caracter�sticas y m�todos de un coche.
  ...
  public Pi040$Furgoneta(int plazas_extra, int capacidad_carga) {
    super(); //Llamar� al constructor de la clase padre 'Pi040$POO_Coche' para traer los datos que este tiene por ejemplo: ruedas = 4; largo = 2000; ancho = 300; etc.
