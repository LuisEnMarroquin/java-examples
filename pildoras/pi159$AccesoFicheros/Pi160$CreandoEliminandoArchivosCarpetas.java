...
public class Pi160$CreandoEliminandoArchivosCarpetas { // Solucionando problemas con diferentes SO con el uso de '/' o '\' en los 'path' con 'File.separator' // VIDEO 160 INICIO
  ...
  public static void main(String[] args) {
    ...
    accede.escribir(archivoDestino); // Llamando al m�todo '.escribir()' de la clase 'Escribiendo'
...
class Escribiendo {
  ...
  public void escribir(String rutaArchivo) {
    ...
    try {
      ...
      FileWriter escritura = new FileWriter(rutaArchivo); // Indica que se va a escribir en el archivo que est� en esa ruta
