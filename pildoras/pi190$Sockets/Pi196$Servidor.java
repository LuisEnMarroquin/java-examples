...
class MarcoServidor6 extends JFrame implements Runnable{ // Implementa Runnable para hacer 'Threads' para que est� permanentemente a la escucha de mensajes
  ...
  public void run() {
    ...
    try {
      ...
      while(true) { // Dentro de un bucle infinito para que acepte m�s mensajes
        ...
        paqueteRecibido = (PaqueteEnvio6) paqueteDatos.readObject(); // Lanza excepci�n de tipo 'ClassNotFoundException'
